...
export const routeMap = [
  ...
  },
  {
    ...
    icon: (
      ...
      </path> <path d="M19 9H14" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"></path> 
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="#000000">
        ...
        <path d="M5 7h13v10H2V4h7l2 2H4v9h1V7z"></path> </g> </g></svg>
    ),
    path: '/categories',
  ...
  },
  {
    ...
    icon: (
      <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
      <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
