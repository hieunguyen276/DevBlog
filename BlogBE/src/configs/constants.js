...
export const DEFAULT_AVATAR = path.join("avatar_default.jpg");
...
export const JOI_DEFAULT_MESSAGE = {
    ...
    "string.invalidName": "{{#label}} không chứa số hoặc ký tự đặc biệt.",
    ...
    "any.notExistsCategory": "{{#label}} không tồn tại hoặc đã bị trùng",
...
// export const VALIDATE_SPECIAL_CHARACTERS = /^[a-zA-Z0-9!@#$%^&*()]+$/;


// Vì vậy, +$ cùng với [a-zA-Z0-9!@#$%^&*()\sÀ-Ỹà-ỹ]+ trong biểu thức chính quy
//  đảm bảo rằng chuỗi phải chứa ít nhất một hoặc nhiều ký tự từ 
// nhóm [a-zA-Z0-9!@#$%^&*()\sÀ-Ỹà-ỹ] và không được kết thúc bằng một ký tự khác.

export const VALIDATE_SPECIAL_CHARACTERS = /^[a-zA-Z0-9\sÀ-Ỹà-ỹ]+$/;
